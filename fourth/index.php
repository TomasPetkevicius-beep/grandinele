...
<head>
    ...
    <title>Ketvirta grandinėlė</title>
...
function first(){
    ...
    else if ($_POST['first'] == "valas" && $_POST['second'] == "volas" && $_POST['third'] == "Rolas" && $_POST['fourth'] == "rokas") {
        header("Location: /php/tomas_projektas/fourth/correct/index.php");
    }
    else { header("Location: /php/tomas_projektas/fourth/incorrect/index.php");
    }
}
    first();
 ?>
