...
<head>
    ...
    <title>Septinta grandinėlė</title>
...
function first(){
    ...
    else if ($_POST['first'] == "karta" && $_POST['second'] == "korta" && $_POST['third'] == "Morta" && $_POST['fourth'] == "mirta") {
        header("Location: /php/tomas_projektas/seventh/correct/index.php");
    }
    else { header("Location: /php/tomas_projektas/seventh/incorrect/index.php");
    }
}
    first();
 ?>
